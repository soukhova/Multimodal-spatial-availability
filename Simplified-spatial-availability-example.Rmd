...
OD_2 <- OD_2 %>%
  mutate(f = case_when(mode == "transit" ~ dlnorm(tt,
                                                  HW_transit_lnorm$estimate["meanlog"], 
                                                  HW_transit_lnorm$estimate["sdlog"]),
...
bbox_new1 <- st_bbox(zn%>%filter(Municipality == "Madrid")) # current bounding box
