...
#NOTE: maybe we can try a distance based distribution???? Not really convinced why would could - perhaps to include all modes?
...
Plot V (spatial availability) by origin-mode (first zn1259 then zn208):
```{r}
SA_im_V_plot <- ggplot() +
  geom_sf(data = SA_im,
          aes(fill = V_im),
