...
toy_example_plot
ggsave("Presentation-images/toy-example1.png",dpi=600)
```
...
knitr::include_graphics("Presentation-images/access-demo.png")
```
...
knitr::include_graphics("Presentation-images/toy-example1.png")
```
...
knitr::include_graphics("Presentation-images/im_populations_zn208_plot.png")
```
