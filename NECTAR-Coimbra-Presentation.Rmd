---
title: "Quantifying multi-modal competition using spatial availability"
subtitle: "NECTAR - Sustainable Neighbourhoods"
...
od_tt_m <- data.frame(i = c("A", "A", "A", "A", "A", "A",
                    ...
                    tt = c(15, 30, 100, 10, 25, 80, #travel time, z-mode (original) AND THEN x-mode (the faster mode)
                           30, 15, 100, 25,  10,  80,
                           100, 100, 15, 80, 80, 10), 
                    pop = c(16666.66666, 16666.66666, 16666.66666, 33333.33333, 33333.33333, 33333.33333,
...
od_table <- data.frame(Center = c("A", "B", "C", "1", "2", "3"),
  Size = c("50,000 pop.", "150,000 pop.", "10,000 pop.", 
...
toy_example_plot
ggsave("Presentations/toy-example1.png",dpi=600)
```
...
```{r, toy-example0, out.width='40%', fig.align='center', echo=FALSE}
knitr::include_graphics("Presentations/access-demo.png")
```
...
```{r, toy-example00, out.width='40%', fig.align='center', echo=FALSE}
knitr::include_graphics("Presentations/access-demo.png")
```
...
knitr::include_graphics("Presentations/toy-example1.png")
```
...
knitr::include_graphics("Presentations/im_populations_zn208_plot.png")
```
...
### Multi-modal home-to-work accessibility in Madrid: 2018 travel survey
```{r, echo=FALSE, out.width='70%',fig.align='center'}
knitr::include_graphics("Presentations/Hansen_im_V_zn208_plot.png")
```
...
### Multi-modal home-to-work accessibility in Madrid: 2018 travel survey
```{r, echo=FALSE, out.width='70%',fig.align='center'}
knitr::include_graphics("Presentations/SA_im_V_zn208_plot.png")
```
